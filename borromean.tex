...
\[ e_0 = H(s_{1,m_0-1}G - e_{1,m_0-1}P_{1,0} \| \cdots \| s_{n,m_n-1}G - e_{n,m_n-1}P_{i,m_n-1}) \]
...
\item Compute $e_0' = H(R_{0,m_0-1} \|\cdots \| R_{n,m_n-1})$ and return 1 iff $e_0'\stackrel{?}{=} e_0$.
\end{enumerate}
